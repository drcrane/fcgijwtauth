...
void SHA256_Final(uint8_t hash[SHA256_DIGEST_LENGTH], SHA256_CTX *ctx)
{
	...
	/* Append message length (big-endian) */
...
void sha256_hashtostring(unsigned char * hash, char * output_buffer) {
	int i = 0;
...
void sha256_buf(void * buf, size_t buf_len, char output_buffer[65]) {
	...
	sha256_hashtostring(hash, output_buffer);
}
